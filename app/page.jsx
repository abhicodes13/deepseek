    ...
    <div>
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center items-center bg-[#000000f2] px-4 pb-8 text-white relative">
          <div className="absolute w-80 h-90  bg-[#4d6afe]  rounded-[80%] -top-65 md:hidden  blur-[100px] mask-t-to-20%"></div>
          ...
          {messages.length === 0 ? (
            ...
            <div
              ref={containerRef}
              className="relative flex flex-col items-center justify-center w-full mt-20 max-h-screen overflow-y-auto"
            >
