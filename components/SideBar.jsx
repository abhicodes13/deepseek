...
const SideBar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between bg-[#19191a] pt-7  border-r-1 transition-all z-50 max-md:not-last:absolute max-md:h-screen ${
    ...
    >
      <div>
        ...
        >
          ...
          <div
            ...
            className="group relative flex items-center justify-center hover:bg-gray-50 transition-all duration-200 h-9 w-9 aspect-square  rounded-lg cursor-pointer"
          >
      ...
      <div>
        <div
          className={`flex items-center  p-2.5 cursor-pointer group relative ${
            expand
              ? "gap-1 text-white/80 text-sm border border-primary rounded-lg hover:bg-white/10 cursor-pointer"
        ...
        >
          ...
          >
            <div className="relative w-max bg-black text-white p-3 rounded-lg shadow-lg">
        ...
        <div
          ...
          }gap-3 text-white/60 text-sm p-2.5 mt-2 cursor-pointer`}
        >
          {user ? (
            <UserButton />
          ) : (
